...
import { useNavigate } from 'react-router-dom';                 // Импортируем компонент для перенаправления пользователя на страницу с сессией
...
const MainScreen = () => {                                  // инициализация MainScreen const MainScreen = () => { /* код компонента */ };
    ...
    const navigate = useNavigate();                                // инициализация функции для редиректа
